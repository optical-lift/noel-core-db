...
recovery_registry_v14="custody/post-fence-migration-recoveries-v14.json"
recovery_registry_v15="custody/post-fence-migration-recoveries-v15.json"
...
recovery_registry_v18="custody/post-fence-migration-recoveries-v18.json"
...
for required in \
  ...
  "$recovery_registry_v14" \
  "$recovery_registry_v15" \
  "$recovery_registry_v16" \
  "$recovery_registry_v17" \
  "$recovery_registry_v18" \
...
declare -A sealed_registry_sha=(
  ...
  ["$recovery_registry_v15"]="98bd248bec3f82d40a9d8273936a6b344584a010"
  ["$recovery_registry_v16"]="8481f5c492b7ebb86966ea69990ac0830ea6f4e5"
  ["$recovery_registry_v17"]="7973d0903dcd9dbab0ee00847f3eca4750a01f55"
  ["$recovery_registry_v18"]="fdd1d44c280056e5b551d964d37e453e8721ecbf"
)
for registry in "$recovery_registry_v4" "$recovery_registry_v5" "$recovery_registry_v6" "$recovery_registry_v7" "$recovery_registry_v8" "$recovery_registry_v9" "$recovery_registry_v10" "$recovery_registry_v11" "$recovery_registry_v12" "$recovery_registry_v13" "$recovery_registry_v14" "$recovery_registry_v15" "$recovery_registry_v16" "$recovery_registry_v17" "$recovery_registry_v18"; do
...
specs = [
    ...
    (Path('custody/post-fence-migration-recoveries-v14.json'), 14, 'post-fence-migration-recoveries-v13.json'),
    (Path('custody/post-fence-migration-recoveries-v15.json'), 15, 'post-fence-migration-recoveries-v14.json'),
    ...
    (Path('custody/post-fence-migration-recoveries-v18.json'), 18, 'post-fence-migration-recoveries-v17.json'),
]
...
echo "Database custody checks passed: inherited history fenced through $fence_version; new migrations belong to noel-core-db; 102 sealed retrospective recoveries preserve exact live bytes."
