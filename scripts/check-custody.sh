...
echo "Database custody checks passed: inherited history fenced through $fence_version; new migrations belong to noel-core-db; 86 sealed retrospective recoveries preserve exact live bytes."