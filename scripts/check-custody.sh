...
echo "Database custody checks passed: inherited history fenced through $fence_version; new migrations belong to noel-core-db; 197 sealed retrospective recovery identities preserve exact live bytes."
