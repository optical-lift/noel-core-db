-- Repair Phase D personnel handle lifecycle to preserve historical-record read compatibility.
-- A Sealed Reality Handle is a stable execution handle, not a mirror of record current/superseded state.
...
select
  ...
  jsonb_build_object(
    'basis','restricted_personnel_phase_d_history_backfill',
    'sourceRecordId',r.id
  )
