...
-- Migration identity uses the pinned Supabase CLI v2.116.0 GetCurrentTimestamp algorithm: current UTC YYYYMMDDHHMMSS.
...
-- Hardening overlay: correct the activation lookup and enforce immutable identity/custody fields.
begin;
