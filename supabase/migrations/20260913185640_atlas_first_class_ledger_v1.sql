...
-- Establishes canonical Ledger identity, explicit Principal -> Ledger root authority,
-- and compatibility attachment for current organization-scoped Ledger reality.
