-- Personal Atlas setup/read membrane for the real Today onboarding practice.
-- Canonical household event/rhythm truth remains owned by the existing Atlas household kernels.
