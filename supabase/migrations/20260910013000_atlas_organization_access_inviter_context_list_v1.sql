...
-- Gate 1: expose only organizations for which the signed-in human already has
-- the same authority accepted by organization_access_inviter_context_self_v1.
-- This is a read projection; it creates no membership, seat, authority,
-- responsibility, position, exposure, or Personal Atlas relationship.
