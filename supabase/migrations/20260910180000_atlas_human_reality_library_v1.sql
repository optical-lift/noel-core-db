...
('household.animal_veterinary_care',1,'animals.responsibility','exists',null,'require',0,'Animal-care relevance requires an explicit animal-responsibility answer.'),
('household.animal_veterinary_care',1,'animals.responsibility','neq','"none"'::jsonb,'require',0,'Animal-care relevance requires actual animal responsibility, not a negative answer.'),
