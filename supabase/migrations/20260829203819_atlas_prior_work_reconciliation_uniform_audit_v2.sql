...
begin
  ...
  return jsonb_build_object(
    ...
    'truthBoundary',jsonb_build_object(
      ...
      'allAnswersShareOneTaskAuditMarker',true
    )
  );
end;
$function$;
...
begin
  ...
  begin
    ...
    select count(*) into v_count from atlas.tasks t where t.id=any(v_task_ids) and t.metadata ? 'latest_prior_work_reconciliation';
