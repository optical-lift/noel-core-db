...
begin
  ...
  select coalesce(jsonb_agg(
    (item - 'organizationId' - 'organizationName') || jsonb_build_object(
      'organizationId',o.id,
      'organizationName',o.name,
...
begin
  ...
  select coalesce(jsonb_agg(
    (item - 'organization_id' - 'organization') || jsonb_build_object(
...
begin
  ...
  v_principal:=(v_base->'principal' - 'organizationId') || jsonb_build_object(
    'organizationId',null,
