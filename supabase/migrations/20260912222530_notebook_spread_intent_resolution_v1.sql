...
-- Durable spreads are notebook objects, not person-life-only objects.
-- This migration is intentionally early: production has no spread instances yet.
do $guard$
begin
...
-- Retire the narrower v1 writer/resolver signatures before adding required identity fields.
...
declare
  ...
  v_spread_id uuid;
  v_binding jsonb;
  v_existing atlas.notebook_spread_intent_requests%rowtype;
begin
