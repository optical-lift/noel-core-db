create or replace function public.wnph_commit_publication_media_source_receipt_v2(
  p_request_id uuid,
  p_token text,
  p_receipt_key text,
  p_fetch_uri text,
...
begin
  ...
  if p_receipt_key='publication-raster:ia-bookreader-w1600:v1' then
    if v_p.placement_key='dewy:plate:frontispiece' and v_a.asset_key='dewy:loc:source-surface:0006' then
      v_expected_uri:='https://archive.org/download/wishfairydewydea00colv/page/n5_w1600.jpg';
    elsif v_p.placement_key='dewy:plate:page-9' and v_a.asset_key='dewy:loc:source-surface:0013' then
    ...
    elsif v_p.placement_key='dewy:plate:page-29' and v_a.asset_key='dewy:loc:source-surface:0033' then
      v_expected_uri:='https://archive.org/download/wishfairydewydea00colv/page/n32_w1600.jpg';
    elsif v_p.placement_key='dewy:plate:page-37' and v_a.asset_key='dewy:loc:source-surface:0041' then
      v_expected_uri:='https://archive.org/download/wishfairydewydea00colv/page/n40_w1600.jpg';
    elsif v_p.placement_key='dewy:plate:page-47' and v_a.asset_key='dewy:loc:source-surface:0051' then
      v_expected_uri:='https://archive.org/download/wishfairydewydea00colv/page/n50_w1600.jpg';
    elsif v_p.placement_key='dewy:plate:page-55' and v_a.asset_key='dewy:loc:source-surface:0059' then
      v_expected_uri:='https://archive.org/download/wishfairydewydea00colv/page/n58_w1600.jpg';
    else
