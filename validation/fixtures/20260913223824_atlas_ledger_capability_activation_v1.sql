...
insert into atlas.organizations(id,stable_key,name,status,metadata,onboarding_state) values (
  ...
  'cap_fixture_org_owner','Capability Fixture Organization','active','{"validation_fixture":true}'::jsonb,'ready'
);
...
insert into atlas.organization_memberships(
  ...
  'b4000000-0000-4000-8000-000000000001'::uuid,
  'b1000000-0000-4000-8000-000000000001'::uuid,
  'owner',true,'{}'::jsonb,'b1000000-0000-4000-8000-000000000011'::uuid
);

insert into atlas.implementation_practitioners(human_user_id,status,authorization_basis,metadata) values (
  'f1000000-0000-4000-8000-000000000001'::uuid,'active','{"basis":"capability_activation_validation"}'::jsonb,'{"validation_fixture":true}'::jsonb
);
...
insert into atlas.implementation_purchases(
  ...
  'c1000000-0000-4000-8000-000000000001'::uuid,'capability-activation-fixture-checkout','fixture-titus','Capability Activation Fixture',
...
insert into atlas.implementation_cases(id,implementation_purchase_id,state,metadata) values (
  'c1000000-0000-4000-8000-000000000011'::uuid,'c1000000-0000-4000-8000-000000000001'::uuid,'in_implementation','{"validation_fixture":true}'::jsonb
);
...
('c1000000-0000-4000-8000-000000000021'::uuid,'c1000000-0000-4000-8000-000000000011'::uuid,'f1000000-0000-4000-8000-000000000001'::uuid,'practitioner',true,null,'{"basis":"capability_activation_validation"}'::jsonb,'{}'::jsonb),
('c1000000-0000-4000-8000-000000000022'::uuid,'c1000000-0000-4000-8000-000000000011'::uuid,'b1000000-0000-4000-8000-000000000001'::uuid,'setup_sponsor',true,now(),'{"basis":"capability_activation_validation"}'::jsonb,'{}'::jsonb);
...
insert into atlas.ledger_entitlements(
  ...
  'c1000000-0000-4000-8000-000000000031'::uuid,'c1000000-0000-4000-8000-000000000011'::uuid,'c1000000-0000-4000-8000-000000000001'::uuid,
  1,'atlas_ledger','baseline_first','activated',300000,40000,'{"source":"capability_activation_validation"}'::jsonb,'{"validation_fixture":true}'::jsonb
);
...
insert into atlas.ledger_entitlement_bindings(
  ...
  'c1000000-0000-4000-8000-000000000041'::uuid,'c1000000-0000-4000-8000-000000000011'::uuid,'c1000000-0000-4000-8000-000000000031'::uuid,
  'b4000000-0000-4000-8000-000000000001'::uuid,null,'c1000000-0000-4000-8000-000000000021'::uuid,
  'activated',now(),now(),'{"source":"capability_activation_validation"}'::jsonb,'{"validation_fixture":true}'::jsonb,'a2000000-0000-4000-8000-000000000001'::uuid
);
