-- Clone-only fixture for Responsibility Reality preview v1.
...
insert into atlas.implementation_purchases(
  ...
  'stripe','cs_validation_responsibility_preview','validation_responsibility_preview',
  'Responsibility Proof','pay_in_full','active','usd',0,0,'{"validationFixture":true}'::jsonb
);
...
(
  ...
  'responsibility_proof_org','Responsibility Proof','active','{"validationFixture":true}'::jsonb,'ready'
),
(
  'f4700000-0000-4000-8000-000000000202'::uuid,
  'responsibility_outside_org','Outside Responsibility Org','active','{"validationFixture":true}'::jsonb,'ready'
);
...
insert into atlas.organization_responsibilities(
  ...
  'f4700000-0000-4000-8000-000000000201'::uuid,
  'existing_stewardship','Existing Stewardship','stewardship','active',
...
values (
  ...
  'f4700000-0000-4000-8000-000000000002'::uuid,
  'responsibility_setup_sponsor','Responsibility Setup Sponsor','active',
  '{"validationFixture":true}'::jsonb
);
...
values (
  ...
  'responsibilityledger01','Responsibility Proof Ledger',null,
...
insert into atlas.ledger_entitlement_bindings(
  ...
  'f4700000-0000-4000-8000-000000000241'::uuid,
  'f4700000-0000-4000-8000-000000000201'::uuid,
  null,'f4700000-0000-4000-8000-000000000121'::uuid,
...
(
  ...
  'manual_semantic_construction','Responsibility Proof has Responsibility Production stewardship.',
  '{"kind":"organization_responsibility","label":"Production stewardship","resolution":"proposed"}'::jsonb,
  '{"kind":"organization","label":"Responsibility Proof","resolution":"canonical","canonicalId":"f4700000-0000-4000-8000-000000000201"}'::jsonb,
...
(
  ...
  '{"kind":"organization_responsibility","label":"Missing Kind","resolution":"proposed"}'::jsonb,
  '{"kind":"organization","label":"Responsibility Proof","resolution":"canonical","canonicalId":"f4700000-0000-4000-8000-000000000201"}'::jsonb,
...
(
  ...
  'f4700000-0000-4000-8000-000000000111'::uuid,
  'implementation_reality_candidate_v2','organization_responsibility.establish',
  'manual_semantic_construction','Existing responsibility.',
  '{"kind":"organization_responsibility","label":"Existing Stewardship","resolution":"proposed"}'::jsonb,
  '{"kind":"organization","label":"Responsibility Proof","resolution":"canonical","canonicalId":"f4700000-0000-4000-8000-000000000201"}'::jsonb,
  null,'{"responsibilityKind":"stewardship"}'::jsonb,'[]'::jsonb,null,'proposed',
  'f4700000-0000-4000-8000-000000000001'::uuid,'{"validationFixture":true}'::jsonb
),
(
  'f4700000-0000-4000-8000-000000000304'::uuid,
  'f4700000-0000-4000-8000-000000000111'::uuid,
  'implementation_reality_candidate_v2','organization_responsibility.establish',
  'manual_semantic_construction','Outside responsibility.',
  '{"kind":"organization_responsibility","label":"Outside Duty","resolution":"proposed"}'::jsonb,
  '{"kind":"organization","label":"Outside Responsibility Org","resolution":"canonical","canonicalId":"f4700000-0000-4000-8000-000000000202"}'::jsonb,
  null,'{"responsibilityKind":"execution"}'::jsonb,'[]'::jsonb,null,'proposed',
  'f4700000-0000-4000-8000-000000000001'::uuid,'{"validationFixture":true}'::jsonb
),
(
  'f4700000-0000-4000-8000-000000000305'::uuid,
  'f4700000-0000-4000-8000-000000000111'::uuid,
  'implementation_reality_candidate_v2','organization_responsibility.establish',
  'manual_semantic_construction','Technical key.',
  '{"kind":"organization_responsibility","label":"Technical Duty","resolution":"proposed"}'::jsonb,
  '{"kind":"organization","label":"Responsibility Proof","resolution":"canonical","canonicalId":"f4700000-0000-4000-8000-000000000201"}'::jsonb,
  null,'{"responsibilityKind":"execution","stableKey":"nope"}'::jsonb,'[]'::jsonb,null,'proposed',
  'f4700000-0000-4000-8000-000000000001'::uuid,'{"validationFixture":true}'::jsonb
);
