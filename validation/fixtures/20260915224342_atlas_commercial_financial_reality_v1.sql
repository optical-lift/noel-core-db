...
insert into atlas.person_auth_credentials(
  id,person_id,auth_user_id,status,provenance
) values (
...
insert into atlas.farms(
  id,organization_id,organization_unit_id,stable_key,name,status,metadata
) values
(
...
insert into atlas.farm_memberships(
  id,user_id,farm_id,role,active,permissions
) values
(
