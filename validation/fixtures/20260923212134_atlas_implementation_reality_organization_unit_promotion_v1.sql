-- Clone-only fixture for Atlas Implementation Reality Organization Unit Promotion Command v1.
-- Requires the separately released Organization Unit preview family.
...
insert into atlas.implementation_purchases(
  ...
  'stripe','cs_validation_org_unit_command','validation_org_unit_command',
  'Organization Unit Command Proof','pay_in_full','active','usd',0,0,
  '{"validationFixture":true}'::jsonb
);
...
insert into atlas.organizations(
  ...
  'org_unit_command_org','Organization Unit Command Proof','active',
...
insert into atlas.organization_units(
  ...
  'f4500000-0000-4000-8000-000000000201'::uuid,
  null,'command_parent','Command Parent','operating_business','active',
  '{"validationFixture":true}'::jsonb
);
...
insert into atlas.principals(
  ...
  'f4500000-0000-4000-8000-000000000002'::uuid,
  'org_unit_command_sponsor','Organization Unit Command Sponsor','active',
  '{"validationFixture":true}'::jsonb
);
...
insert into atlas.ledgers(
  ...
  'f4500000-0000-4000-8000-000000000231'::uuid,
  'orgunitcommandledger001','Organization Unit Command Ledger',null,
...
insert into atlas.principal_ledger_authorities(
  ...
  'f4500000-0000-4000-8000-000000000232'::uuid,
  'f4500000-0000-4000-8000-000000000221'::uuid,
  'f4500000-0000-4000-8000-000000000231'::uuid,
...
insert into atlas.ledger_organization_participations(
  ...
  'f4500000-0000-4000-8000-000000000233'::uuid,
  'f4500000-0000-4000-8000-000000000231'::uuid,
  'f4500000-0000-4000-8000-000000000201'::uuid,
...
insert into atlas.ledger_entitlements(
  ...
  'f4500000-0000-4000-8000-000000000241'::uuid,
  'f4500000-0000-4000-8000-000000000111'::uuid,
  'f4500000-0000-4000-8000-000000000101'::uuid,
...
insert into atlas.ledger_entitlement_bindings(
  ...
  'f4500000-0000-4000-8000-000000000242'::uuid,
  'f4500000-0000-4000-8000-000000000111'::uuid,
  'f4500000-0000-4000-8000-000000000241'::uuid,
  'f4500000-0000-4000-8000-000000000201'::uuid,
  null,
...
(
  ...
  'Loose authored wording, not canonical rendering.',
  '{"kind":"organization_unit","label":"Field Operations","resolution":"proposed"}'::jsonb,
  '{"kind":"organization","label":"Organization Unit Command Proof","resolution":"canonical","canonicalId":"f4500000-0000-4000-8000-000000000201"}'::jsonb,
  '{"kind":"organization_unit","label":"Command Parent","resolution":"canonical","canonicalId":"f4500000-0000-4000-8000-000000000211"}'::jsonb,
  '{"unitKind":"program"}'::jsonb,
  '["fixture:org-unit-command:field-operations"]'::jsonb,
  '{"kind":"reconstruction_of_existing_reality","reference":"fixture:org-unit-command:field-operations"}'::jsonb,
  'proposed',
  'f4500000-0000-4000-8000-000000000001'::uuid,
  '{"validationFixture":true}'::jsonb
),
(
  ...
  '{"kind":"organization_unit","label":"Blocked Unit","resolution":"proposed"}'::jsonb,
  '{"kind":"organization","label":"Organization Unit Command Proof","resolution":"canonical","canonicalId":"f4500000-0000-4000-8000-000000000201"}'::jsonb,
