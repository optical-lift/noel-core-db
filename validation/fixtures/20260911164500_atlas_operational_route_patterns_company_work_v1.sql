-- Atlas operational route pattern / Company Work integration fixture.
-- This fixture is disposable and MUST roll back.
...
begin
  ...
  if v_org is null then
    raise exception 'Fixture requires an organization with an active Owner membership.';
  end if;
