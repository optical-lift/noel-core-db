-- Validation-only rows for the disposable production-schema clone.
-- Creates one Principal whose only initially unanswered Discovery question is
-- the deliberately over-scored riding-mower specialization.

insert into auth.users(id,aud,role,email,created_at,updated_at,is_sso_user,is_anonymous)
values('11111111-1111-4111-8111-111111111111','authenticated','authenticated','package-1-discovery-fixture@example.invalid',now(),now(),false,false);

insert into atlas.principals(id,user_id,stable_key,name,status,metadata)
values('22222222-2222-4222-8222-222222222222','11111111-1111-4111-8111-111111111111','fixture-package-1-discovery','Package 1 Discovery Fixture','active','{}'::jsonb);
...
('household.people_shape','people','Fixture household','single_choice','[]'::jsonb,100,1,0,0,'household.people_shape','Fixture','{}'::jsonb,true),
...
('22222222-2222-4222-8222-222222222222','11111111-1111-4111-8111-111111111111','household.people_shape','fixture-02','"just_me"'::jsonb,'{}'::jsonb),
...
('22222222-2222-4222-8222-222222222222','11111111-1111-4111-8111-111111111111','transport.vehicle_count','fixture-08','"one"'::jsonb,'{}'::jsonb),
('22222222-2222-4222-8222-222222222222','11111111-1111-4111-8111-111111111111','household.child_count','fixture-09','"1"'::jsonb,'{}'::jsonb),
...
('22222222-2222-4222-8222-222222222222','11111111-1111-4111-8111-111111111111','animals.responsibility','fixture-11','"none"'::jsonb,'{}'::jsonb),
('22222222-2222-4222-8222-222222222222','11111111-1111-4111-8111-111111111111','life.weekday_anchor','fixture-12','"job"'::jsonb,'{}'::jsonb),
