...
insert into atlas.implementation_purchases(
  ...
  'stripe','cs_validation_position_preview','validation_position_preview',
  'Position Proof','pay_in_full','active','usd',0,0,'{"validationFixture":true}'::jsonb
);
...
(
  ...
  'position_proof_org','Position Proof','active','{"validationFixture":true}'::jsonb,'ready'
),
(
  'f4600000-0000-4000-8000-000000000202'::uuid,
  'position_outside_org','Outside Position Organization','active','{"validationFixture":true}'::jsonb,'ready'
);
...
(
  ...
  'f4600000-0000-4000-8000-000000000202'::uuid,
  null,'outside_operations','Outside Operations','department','active','{"validationFixture":true}'::jsonb
);
...
insert into atlas.organization_positions(
  ...
  'f4600000-0000-4000-8000-000000000201'::uuid,
  'f4600000-0000-4000-8000-000000000211'::uuid,
  'existing_lead','Existing Lead','management','active','{"validationFixture":true}'::jsonb
);

insert into atlas.principals(id,user_id,stable_key,name,status,metadata)
values (
  'f4600000-0000-4000-8000-000000000231'::uuid,
  'f4600000-0000-4000-8000-000000000002'::uuid,
  'position_setup_sponsor','Position Setup Sponsor','active','{"validationFixture":true}'::jsonb
);

insert into atlas.ledgers(id,stable_key,name,organization_id,ledger_kind,status,metadata)
values (
  'f4600000-0000-4000-8000-000000000241'::uuid,
  'positionproofledger001','Position Proof Ledger',null,'governed_reality','active',
...
insert into atlas.principal_ledger_authorities(
  ...
  'f4600000-0000-4000-8000-000000000242'::uuid,
  'f4600000-0000-4000-8000-000000000231'::uuid,
  'f4600000-0000-4000-8000-000000000241'::uuid,
...
insert into atlas.ledger_organization_participations(
  ...
  'f4600000-0000-4000-8000-000000000243'::uuid,
  'f4600000-0000-4000-8000-000000000241'::uuid,
  'f4600000-0000-4000-8000-000000000201'::uuid,
...
insert into atlas.ledger_entitlements(
  ...
  'f4600000-0000-4000-8000-000000000251'::uuid,
  'f4600000-0000-4000-8000-000000000111'::uuid,
  'f4600000-0000-4000-8000-000000000101'::uuid,
...
insert into atlas.ledger_entitlement_bindings(
  ...
  'f4600000-0000-4000-8000-000000000252'::uuid,
  'f4600000-0000-4000-8000-000000000111'::uuid,
  'f4600000-0000-4000-8000-000000000251'::uuid,
  'f4600000-0000-4000-8000-000000000201'::uuid,
  null,
