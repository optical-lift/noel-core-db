-- Clone-only fixture for Personal Reality Institutional Anchor v1.
-- Deliberately establishes only the minimum Personal Reality custody needed
-- to exercise proposal + human confirmation. It creates no Organization,
-- Commercial Composition, Implementation Case, purchase, or entitlement.

insert into auth.users(id,email,created_at,updated_at)
values (
  'f6a10000-0000-4000-8000-000000000001'::uuid,
  'institutional-anchor-proof@example.invalid',
  now(),
  now()
);
...
insert into atlas.principals(
  ...
  'f6a10000-0000-4000-8000-000000000002'::uuid,
  'f6a10000-0000-4000-8000-000000000001'::uuid,
  'validation:personal-institutional-anchor-v1',
  'Institutional Anchor Proof',
  'America/Chicago',
  'active',
...
insert into atlas.evidence_records(
  ...
  'f6a10000-0000-4000-8000-000000000003'::uuid,
  'person',
  'f6a10000-0000-4000-8000-000000000001'::uuid,
  'personal.reality',
  'testimony',
  'f6a10000-0000-4000-8000-000000000004',
...
insert into atlas.personal_reality_captures(
  ...
  'f6a10000-0000-4000-8000-000000000004'::uuid,
  'f6a10000-0000-4000-8000-000000000002'::uuid,
  'f6a10000-0000-4000-8000-000000000001'::uuid,
  'validation:personal-institutional-anchor-v1',
  'Payroll is Friday.',
