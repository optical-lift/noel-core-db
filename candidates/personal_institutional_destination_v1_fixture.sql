-- Clone-only fixture for Personal Institutional Destination v1.
-- Requires Institutional Anchor + Resolver parents to be live in the clone.

insert into auth.users(id,email,created_at,updated_at)
values (
  'f6c10000-0000-4000-8000-000000000001'::uuid,
  'institutional-destination-proof@example.invalid',
  now(),now()
);
...
insert into atlas.principals(
  ...
  'f6c10000-0000-4000-8000-000000000002'::uuid,
  'f6c10000-0000-4000-8000-000000000001'::uuid,
  'validation:personal-institutional-destination-v1',
  'Institutional Destination Proof',
  'America/Chicago',
  'active',
...
insert into atlas.evidence_records(
  ...
  'f6c10000-0000-4000-8000-000000000003'::uuid,
  'person',
  'f6c10000-0000-4000-8000-000000000001'::uuid,
  'personal.reality',
  'testimony',
  'f6c10000-0000-4000-8000-000000000004',
...
insert into atlas.personal_reality_captures(
  ...
  'f6c10000-0000-4000-8000-000000000004'::uuid,
  'f6c10000-0000-4000-8000-000000000002'::uuid,
  'f6c10000-0000-4000-8000-000000000001'::uuid,
  'validation:personal-institutional-destination-v1',
  'Payroll is Friday.',
